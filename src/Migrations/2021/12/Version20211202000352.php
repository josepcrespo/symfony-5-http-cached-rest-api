...
final class Version20211202000352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT NOT NULL, team_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, birth_date DATETIME(255) NOT NULL, position VARCHAR(255) NOT NULL, salary INT DEFAULT NULL, timestamp TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
